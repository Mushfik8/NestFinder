...
function App() {
    ...
    <div className={`${darkMode ? 'dark' : ''}`}>
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-950 dark:to-purple-950 transition-colors duration-500">
        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrollY > 50 ? 'bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-lg' : 'bg-transparent'
        }`}>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 px-6">
          <div className="absolute inset-0 overflow-hidden">
            <img src="https://images.pexels.com/photos/3182773/pexels-photo-3182773.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Modern apartment" className="absolute inset-0 w-full h-full object-cover opacity-15 dark:opacity-10" />
            <div className="absolute inset-0 bg-gradient-to-b from-white/0 via-white/50 to-white/80 dark:from-gray-900/0 dark:via-gray-900/50 dark:to-gray-900/80"></div>
            ...
            <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-400/30 dark:bg-purple-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
              ...
              <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                Nest, Anywhere in the World
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Nest Finder connects tenants and homeowners in a single click — simple, secure, and global.
            </p>
            ...
            <div className="pt-12 animate-bounce">
              <div className="w-6 h-10 border-2 border-gray-400 dark:border-gray-600 rounded-full mx-auto relative">
                <div className="w-1.5 h-2 bg-gray-400 dark:bg-gray-600 rounded-full absolute top-2 left-1/2 -translate-x-1/2 animate-scroll"></div>
              </div>
            </div>
          </div>
        </section>
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
              ...
              {/* <div className="relative group overflow-hidden rounded-3xl shadow-2xl">
                <img src="https://images.pexels.com/photos/3938373/pexels-photo-3938373.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Home rental" className="w-full h-96 object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
              </div> */}
        ...
        <section id="cta" className="py-24 px-6 relative overflow-hidden">
          <div className="absolute inset-0">
            <img src="https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Team" className="absolute inset-0 w-full h-full object-cover opacity-20 dark:opacity-10" />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="text-center md:text-right text-gray-400">
                <a href="mailto:support@nestfinder.app" className="hover:text-white transition-colors duration-300">
...
function FeatureCard({ icon, title, description, gradient, image }: FeatureCardProps) {
  return (
    <div className="group relative bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 hover:-translate-y-2">
      ...
      <div className="p-8">
        <div className={`w-16 h-16 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 -mt-12 relative z-10 shadow-lg`}>
          {icon}
        </div>
